...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_RED_FLAME,               RCP_HmsFireD_Yellow),
    LOAD_MODEL_FROM_GEO(MODEL_BLUE_FLAME,              RCP_HmsFireD_Blue),
    LOAD_MODEL_FROM_GEO(MODEL_FIRE_1,                  RCP_HmsFireC_Yellow),
    LOAD_MODEL_FROM_GEO(MODEL_FIRE_2,                  RCP_HmsFireC_Blue),
