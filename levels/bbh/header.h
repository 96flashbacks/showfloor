...
// geo
extern const GeoLayout Bbh_dl_0_geo[];
extern const GeoLayout Bbh_dl_1_geo[];
extern const GeoLayout Bbh_dl_2_geo[];
extern const GeoLayout Bbh_dl_3_geo[];
extern const GeoLayout Bbh_dl_4_geo[];
extern const GeoLayout Bbh_dl_5_geo[];
extern const GeoLayout Bbh_dl_6_geo[];
extern const GeoLayout Bbh_dl_7_geo[];
extern const GeoLayout Bbh_dl_8_geo[];
extern const GeoLayout Bbh_dl_9_geo[];
extern const GeoLayout Bbh_dl_10_geo[];
extern const GeoLayout Bbh_dl_11_geo[];
extern const GeoLayout Bbh_dl_12_geo[];
extern const GeoLayout Bbh_dl_13_geo[];
extern const GeoLayout Bbh_dl_14_geo[];
extern const GeoLayout Bbh_dl_15_geo[];
extern const GeoLayout Bbh_dl_16_geo[];
extern const GeoLayout Bbh_area_1[];

// leveldata
extern const Gfx ghost_house_1_dl_mesh[];
extern const Gfx ghost_house_2_dl_mesh[];
extern const Gfx ghost_house_3_dl_mesh[];
extern const Gfx ghost_house_4_dl_mesh[];
extern const Gfx ghost_house_5_dl_mesh[];
extern const Gfx ghost_house_6_dl_mesh[];
extern const Gfx ghost_house_7_dl_mesh[];
extern const Gfx ghost_house_8_dl_mesh[];
extern const Gfx ghost_house_painting_dl_mesh[];
