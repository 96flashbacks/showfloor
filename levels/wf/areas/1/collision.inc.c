const Collision mountain_collision[] = {
	...
	COL_VERTEX(-2047, -3071, 4096),
	COL_VERTEX(2048, -3071, 4096),
	COL_VERTEX(255, 3584, -3071),
	COL_VERTEX(255, 3584, -2559),
	COL_VERTEX(204, 3457, -2585),
	COL_VERTEX(204, 3457, -3045),
	COL_VERTEX(-256, 3584, -2559),
	COL_VERTEX(-205, 3457, -2585),
	COL_VERTEX(-256, 3584, -3071),
	COL_VERTEX(-205, 3457, -3045),
