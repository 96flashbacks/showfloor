...
#define NO_LAYER ((struct SequenceChannelLayer *)(0))
...
#define SEQUENCE_PLAYER_STATE_FADE_IN 4
...
#define poolDisabled poolEntry[0]
#define poolDecaying poolEntry[1]
#define poolReleasing poolEntry[2]
#define poolActive poolEntry[3]
struct NotePool
{
    struct AudioListItem poolEntry[4];
};
...
{
    /*0x00*/ u32 frequency;//always 32000
    /*0x04*/ u8 maxSimultaneousNotes;//always 16 but maybe more in the future
    /*0x05*/ u8 reverbDownsampleRate; // always 1
    /*0x06*/ u16 reverbWindowSize; //always 0x1000
    /*0x08*/ u16 reverbGain;
    /*0x0A*/ u16 volume; //always 0x7f00
    /*0x0C*/ u32 persistentSeqMem; //keep it its useful
    /*0x10*/ u32 persistentBankMem; //keep it its useful
    /*0x14*/ u32 temporarySeqMem; //keep it its useful
    /*0x18*/ u32 temporaryBankMem; //keep it its useful
}; // size = 0x1C
