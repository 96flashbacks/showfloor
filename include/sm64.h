...
#define ACT_START_SLEEPING             0x08400202 // (0x002 | ACT_FLAG_STATIONARY | ACT_FLAG_IDLE | ACT_FLAG_PAUSE_EXIT)
#define ACT_SLEEPING                   0x08000203 // (0x003 | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
#define ACT_WAKING_UP                  0x08000204 // (0x004 | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
...
//#define ACT_UNKNOWN_0002020E           0x0002020E // (0x00E | ACT_FLAG_STATIONARY | ACT_FLAG_INVULNERABLE) // PS_ELECWAIT
#define ACT_CROUCHING                  0x08008220 // (0x020 | ACT_FLAG_STATIONARY | ACT_FLAG_SHORT_HITBOX | ACT_FLAG_PAUSE_EXIT)
#define ACT_START_CROUCHING            0x08008221 // (0x021 | ACT_FLAG_STATIONARY | ACT_FLAG_SHORT_HITBOX | ACT_FLAG_PAUSE_EXIT)
#define ACT_STOP_CROUCHING             0x08008222 // (0x022 | ACT_FLAG_STATIONARY | ACT_FLAG_SHORT_HITBOX | ACT_FLAG_PAUSE_EXIT)
#define ACT_START_CRAWLING             0x08008223 // (0x023 | ACT_FLAG_STATIONARY | ACT_FLAG_SHORT_HITBOX | ACT_FLAG_PAUSE_EXIT)
#define ACT_STOP_CRAWLING              0x08008224 // (0x024 | ACT_FLAG_STATIONARY | ACT_FLAG_SHORT_HITBOX | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_JUMP_LAND_STOP             0x08000230 // (0x030 | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
#define ACT_DOUBLE_JUMP_LAND_STOP      0x08000231 // (0x031 | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
#define ACT_FREEFALL_LAND_STOP         0x08000232 // (0x032 | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
#define ACT_SIDE_FLIP_LAND_STOP        0x08000233 // (0x033 | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_BRAKING_STOP               0x0800023D // (0x03D | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
#define ACT_BUTT_SLIDE_STOP            0x0800023E // (0x03E | ACT_FLAG_STATIONARY | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_HOLD_WALKING               0x04000442 // (0x042 | ACT_FLAG_MOVING | ACT_FLAG_ALLOW_FIRST_PERSON)
...
#define ACT_CRAWLING                   0x00008448 // (0x048 | ACT_FLAG_MOVING | ACT_FLAG_SHORT_HITBOX)
#define ACT_BURNING_GROUND             0x00020449 // (0x049 | ACT_FLAG_MOVING | ACT_FLAG_INVULNERABLE)
//#define ACT_DECELERATING               0x0000044A // (0x04A | ACT_FLAG_MOVING)
...
#define ACT_CROUCH_SLIDE               0x00808459 // (0x059 | ACT_FLAG_MOVING | ACT_FLAG_SHORT_HITBOX | ACT_FLAG_ATTACKING)
...
#define ACT_JUMP_LAND                  0x00000470 // (0x070 | ACT_FLAG_MOVING)
#define ACT_FREEFALL_LAND              0x00000471 // (0x071 | ACT_FLAG_MOVING)
#define ACT_DOUBLE_JUMP_LAND           0x00000472 // (0x072 | ACT_FLAG_MOVING)
#define ACT_SIDE_FLIP_LAND             0x00000473 // (0x073 | ACT_FLAG_MOVING)
...
#define ACT_TWIRLING                   0x138008A4 // (0x0A4 | ACT_FLAG_AIR | ACT_FLAG_ATTACKING | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_CONTROL_JUMP_HEIGHT)
...
#define ACT_WATER_PICK_UP                0x300024E1 // (0x0E1 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
