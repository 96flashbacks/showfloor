...
extern const BehaviorScript bhvMotosProjectile[];
...
extern const BehaviorScript bhvKeyInsideBoo[];
...
extern const BehaviorScript bhvTestPlayerFire[];
...
extern const BehaviorScript bhvMovingCoin[];
extern const BehaviorScript bhvSliderCoin[];
